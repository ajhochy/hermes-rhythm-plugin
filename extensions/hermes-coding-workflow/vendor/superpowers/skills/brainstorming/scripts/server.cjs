...
function brandMarkup() {
  ...
  // The pinned distribution is deliberately self-contained: no remote logo,
  // version beacon, or external branding request is emitted by default.
  return '<div class="brand"><span class="brand-copy">Superpowers (MIT, pinned) v' + version + '</span></div>';
}
