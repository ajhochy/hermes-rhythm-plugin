...
#   * RHYTHM_SHARED_AGENTS_LIVE opts into the local scripted-model native
#     session contract; the default lane starts no listener or agent turn.
#
