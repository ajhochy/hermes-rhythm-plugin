...
function StatePanel2({ state, onRetry, onEmpty }) {
  ...
  if (state === "empty") {
    return /* @__PURE__ */ jsxs("section", { className: "dashboard-state", role: "status", "data-testid": "page-state-empty", children: [
      ...
      /* @__PURE__ */ jsx("button", { className: "primary-button", type: "button", onClick: onEmpty, "data-testid": "dashboard-empty-primary", children: "Create the first task" })
    ] });
  }
...
function TaskEntry({ task, onInspect, onToggle }) {
  return /* @__PURE__ */ jsxs("article", { className: "task-entry", children: [
    /* @__PURE__ */ jsx("button", { className: "task-toggle", type: "button", "aria-label": `${task.status === "done" ? "Reopen" : "Complete"} ${task.title}`, onClick: () => onToggle(task), "data-testid": `task-toggle-${task.id}`, children: /* @__PURE__ */ jsx("span", { "aria-hidden": "true", children: task.status === "done" ? "\u2713" : "\u25CB" }) }),
...
function ProjectStepEntry({ step, onInspect, onToggle }) {
  return /* @__PURE__ */ jsxs("article", { className: "task-entry", children: [
    /* @__PURE__ */ jsx("button", { className: "task-toggle", type: "button", "aria-label": `${step.status === "done" ? "Reopen" : "Complete"} ${step.title}`, onClick: () => onToggle(step), "data-testid": `project-step-toggle-${step.id}`, children: /* @__PURE__ */ jsx("span", { "aria-hidden": "true", children: step.status === "done" ? "\u2713" : "\u25CB" }) }),
  ...
  return /* @__PURE__ */ jsx(ScreenRoot, { screenName: "Dashboard", testId: "rhythm-dashboard-screen", children: /* @__PURE__ */ jsxs("section", { className: "page-shell pg-dashboard", "aria-busy": surfaceState === "loading", children: [
    /* @__PURE__ */ jsxs("header", { className: "dashboard-toolbar", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "dashboard-header-actions", children: [
        ...
        /* @__PURE__ */ jsx(HeaderTaskAction, { onClick: () => setCreateOpen(true), disabled: !isContentVisible || mutationPending, testId: "dashboard-header-add-task" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "dashboard-scroll", children: [
      !isContentVisible && /* @__PURE__ */ jsx(StatePanel2, { state: surfaceState, onRetry: () => void load(), onEmpty: () => setCreateOpen(true) }),
        ...
        /* @__PURE__ */ jsxs("section", { className: "planning-section", "aria-labelledby": "planning-title", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "planning-grid", children: [
            /* @__PURE__ */ jsxs("article", { className: "planning-card wide", "data-testid": "planning-past-due", children: [
              ...
              pastDueTasks.map((task) => /* @__PURE__ */ jsx(TaskEntry, { task, onInspect: setSelectedTask, onToggle: (item) => void toggleTask(item) }, task.id)),
            ...
            /* @__PURE__ */ jsxs("article", { className: "planning-card", "data-testid": "planning-today", children: [
              ...
              todayTasks.map((task) => /* @__PURE__ */ jsx(TaskEntry, { task, onInspect: setSelectedTask, onToggle: (item) => void toggleTask(item) }, task.id))
            ] }),
            /* @__PURE__ */ jsxs("article", { className: "planning-card", "data-testid": "planning-week", children: [
              ...
              weekTasks.map((task) => /* @__PURE__ */ jsx(TaskEntry, { task, onInspect: setSelectedTask, onToggle: (item) => void toggleTask(item) }, task.id)),
            ...
            /* @__PURE__ */ jsxs("article", { className: "planning-card", "data-testid": "planning-project-steps", children: [
              ...
              projectSteps.map((step) => /* @__PURE__ */ jsx(ProjectStepEntry, { step, onInspect: setSelectedStep, onToggle: (item) => void toggleStep(item) }, step.id)),
            ...
            /* @__PURE__ */ jsxs("article", { className: "planning-card wide", "data-testid": "planning-unscheduled", children: [
              ...
              unscheduledTasks.map((task) => /* @__PURE__ */ jsx(TaskEntry, { task, onInspect: setSelectedTask, onToggle: (item) => void toggleTask(item) }, task.id)),
    ...
    /* @__PURE__ */ jsx(FocusDialog, { open: Boolean(selectedTask), onClose: () => setSelectedTask(null), title: "Task details", description: "Inspect or update the selected task.", testId: "task-inspector", wide: true, children: /* @__PURE__ */ jsxs("form", { className: "inspector-form", onSubmit: saveTask, children: [
      /* @__PURE__ */ jsxs("label", { children: [
        "Task title",
        /* @__PURE__ */ jsx("input", { name: "inspectorTitle", defaultValue: selectedTask?.title ?? "", "data-autofocus": true, "data-testid": "task-inspector-title" })
      ] }),
      /* @__PURE__ */ jsxs("label", { children: [
        "Notes",
        /* @__PURE__ */ jsx("textarea", { name: "inspectorNotes", defaultValue: selectedTask?.notes ?? "", rows: 4, "data-testid": "task-inspector-notes" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "inspector-pair", children: [
        /* @__PURE__ */ jsxs("label", { children: [
          "Scheduled date",
          /* @__PURE__ */ jsx("input", { name: "inspectorScheduledDate", type: "date", defaultValue: selectedTask?.scheduledDate ?? "", "data-testid": "task-inspector-scheduled" })
        ] }),
        /* @__PURE__ */ jsxs("label", { children: [
          "Due date",
          /* @__PURE__ */ jsx("input", { name: "inspectorDueDate", type: "date", defaultValue: selectedTask?.dueDate ?? "", "data-testid": "task-inspector-due" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("section", { className: "inspector-collaborator", "aria-label": "Task collaborator", children: [
        ...
        selectedTask?.collaboratorId ? /* @__PURE__ */ jsx("button", { className: "text-danger-button", type: "button", onClick: () => void updateInspectorCollaborator(null), "data-testid": "task-inspector-collaborator-remove", children: "Remove" }) : /* @__PURE__ */ jsxs("button", { className: "secondary-button", type: "button", disabled: !members[0], onClick: () => members[0] && void updateInspectorCollaborator(members[0].id), "data-testid": "task-inspector-collaborator-add", children: [
          "Add ",
      ...
      /* @__PURE__ */ jsxs("footer", { children: [
        ...
        /* @__PURE__ */ jsx("button", { className: "primary-button", type: "submit", disabled: mutationPending, "data-testid": "task-inspector-save", children: "Save changes" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx(FocusDialog, { open: Boolean(selectedStep), onClose: () => setSelectedStep(null), title: "Project step details", description: project ? `${project.title} \xB7 project step` : "Project step", testId: "project-step-inspector", wide: true, children: /* @__PURE__ */ jsxs("form", { className: "inspector-form", onSubmit: (event) => {
      event.preventDefault();
...
function TaskCard({ task, selected, canWrite, onInspect, onComplete, onSelect, onDragStart }) {
  ...
  return /* @__PURE__ */ jsxs("article", { className: `planner-task ${task.readonly ? "project-step" : ""} ${selected ? "selected" : ""}`, "data-status": task.status, children: [
    /* @__PURE__ */ jsxs("button", { className: "task-main", type: "button", draggable: canMutate, "aria-label": `Inspect ${task.title}`, onDragStart: (event) => onDragStart(event, task), onClick: () => onInspect(task), "data-testid": `planner-task-${task.id}`, children: [
  ...
  return /* @__PURE__ */ jsx(ScreenRoot, { screenName: "Planner", testId: "rhythm-planner-screen", children: /* @__PURE__ */ jsxs("section", { className: "page-shell pg-planner", "aria-busy": surfaceState === "loading", children: [
    /* @__PURE__ */ jsxs("header", { className: "planner-toolbar", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "planner-header-actions", children: [
        /* @__PURE__ */ jsx(HeaderTaskAction, { onClick: () => setInspector({ kind: "create" }), disabled: !showsWorkspace || mutationPending || !canWrite, testId: "planner-header-add-task" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "planner-scroll", children: [
      ...
      showsWorkspace && plan && /* @__PURE__ */ jsxs(Fragment, { children: [
        selectedIds.length > 0 && /* @__PURE__ */ jsxs("aside", { className: "selection-bar", "aria-label": "Selected tasks", children: [
          ...
          /* @__PURE__ */ jsx("button", { className: "primary-button", type: "button", disabled: !canWrite, title: !canWrite ? "This host grants inspection only." : void 0, onClick: () => void bulkComplete(), "data-testid": "planner-bulk-complete", children: "Mark complete" }),
        ...
        /* @__PURE__ */ jsxs("section", { className: "planner-board", "aria-label": "Weekly plan", "data-testid": "planner-board", children: [
          /* @__PURE__ */ jsxs("aside", { className: "backlog-lane", "data-testid": "planner-backlog", children: [
            ...
            /* @__PURE__ */ jsx("button", { className: "secondary-button add-control", type: "button", disabled: mutationPending || !canWrite, title: !canWrite ? "This host grants inspection only." : void 0, onClick: () => setInspector({ kind: "create" }), "data-testid": "planner-add-backlog-task", children: "+ Add unscheduled task" }),
            /* @__PURE__ */ jsx("div", { className: "lane-list", children: backlog.map((task) => /* @__PURE__ */ jsx(TaskCard, { task, selected: selectedIds.includes(task.id), canWrite, onInspect: (item) => setInspector({ kind: "task", id: item.id }), onComplete: (item) => void changeStatus(item, item.status === "done" ? "open" : "done"), onSelect: toggleSelected, onDragStart }, task.id)) })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "days-grid", children: plan.days.map((day) => {
            ...
            return /* @__PURE__ */ jsxs("section", { className: "day-lane", "aria-labelledby": `planner-day-title-${day.date}`, onDragOver: (event) => event.preventDefault(), onDrop: (event) => dropOnDay(event, day.date), "data-testid": `planner-day-${day.date}`, children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "lane-list", children: dayTasks.map((task) => /* @__PURE__ */ jsx(TaskCard, { task, selected: selectedIds.includes(task.id), canWrite, onInspect: (item) => setInspector({ kind: "task", id: item.id }), onComplete: (item) => void changeStatus(item, item.status === "done" ? "open" : "done"), onSelect: toggleSelected, onDragStart }, task.id)) }),
              /* @__PURE__ */ jsx("button", { className: "text-button add-control", type: "button", disabled: mutationPending || !canWrite, title: !canWrite ? "This host grants inspection only." : void 0, onClick: () => setInspector({ kind: "create", scheduledDate: day.date }), "data-testid": `planner-add-task-${day.date}`, children: "+ Add task" })
            ] }, day.date);
          }) })
        ] }),
...
function ProjectsScreen() {
  ...
  const [collaboratorPickerFor, setCollaboratorPickerFor] = useState(null);
  ...
  const renderStepRow = (instance, step) => /* @__PURE__ */ jsxs("article", { className: "instance-step", "data-status": step.status, "data-testid": `project-instance-step-${step.id}`, children: [
    /* @__PURE__ */ jsxs("label", { className: "step-check", children: [
      ...
      /* @__PURE__ */ jsx("input", { type: "checkbox", checked: step.status === "done", disabled: mutationPending || !canWrite, title: !canWrite ? "This host grants inspection only." : void 0, onChange: () => void toggleComplete(instance, step), "data-testid": `project-step-complete-${step.id}` }),
    ...
    /* @__PURE__ */ jsxs("label", { className: "milestone-select", children: [
      ...
      /* @__PURE__ */ jsxs("select", { value: step.milestoneId ?? "", disabled: mutationPending || !canWrite, title: !canWrite ? "This host grants inspection only." : void 0, onChange: (event) => void assignMilestone(instance, step, event.target.value), "data-testid": `project-step-milestone-${step.id}`, children: [
  ...
  return /* @__PURE__ */ jsx(ScreenRoot, { screenName: "Projects", testId: "rhythm-projects-screen", children: /* @__PURE__ */ jsxs("section", { className: "page-shell pg-projects", "aria-busy": surfaceState === "loading", children: [
      ...
      showsWorkspace && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("section", { className: "templates-rail", "aria-labelledby": "project-templates-title", children: [
          /* @__PURE__ */ jsxs("header", { children: [
            ...
            /* @__PURE__ */ jsx("button", { className: "secondary-button", type: "button", disabled: !canWrite, title: !canWrite ? "This host grants inspection only." : void 0, onClick: () => setTemplateEditor("new"), "data-testid": "project-template-new", children: "New template" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "template-list", role: "grid", "aria-label": "Project templates", "data-testid": "project-templates-list", children: templates.map((template) => /* @__PURE__ */ jsx("div", { className: "template-row", role: "row", "aria-selected": template.id === selectedTemplate?.id ? "true" : "false", "data-testid": `project-template-${template.id}`, children: /* @__PURE__ */ jsxs("div", { role: "gridcell", children: [
            /* @__PURE__ */ jsxs("button", { className: "template-select", type: "button", onClick: () => setSelectedTemplateId(template.id), "data-testid": `project-template-select-${template.id}`, children: [
            ...
            /* @__PURE__ */ jsx("button", { className: "text-button", type: "button", disabled: !canWrite, onClick: () => setTemplateEditor(template), "data-testid": `project-template-edit-${template.id}`, children: "Edit" }),
            /* @__PURE__ */ jsx("button", { className: "text-danger-button", type: "button", disabled: !canWrite, onClick: () => void deleteTemplate(template), "data-testid": `project-template-delete-${template.id}`, children: "Delete" })
          ] }) }, template.id)) }),
          selectedTemplate && /* @__PURE__ */ jsx("button", { className: "primary-button", type: "button", disabled: !canWrite, title: !canWrite ? "This host grants inspection only." : void 0, onClick: () => setStartOpen(true), "data-testid": "project-start", children: "Start Project" })
        ] }),
        /* @__PURE__ */ jsxs("section", { className: "active-projects", "aria-labelledby": "active-projects-title", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "project-board", children: [
            /* @__PURE__ */ jsx("section", { className: "project-list-pane", "aria-label": "Active project list", children: /* @__PURE__ */ jsxs("div", { className: "instance-list", children: [
              visibleInstances.map((instance) => /* @__PURE__ */ jsx("article", { className: `instance-row${selectedInstance?.id === instance.id ? " selected" : ""}`, "data-testid": `project-instance-${instance.id}`, children: /* @__PURE__ */ jsxs("button", { className: "instance-expand", type: "button", "aria-pressed": selectedInstance?.id === instance.id, onClick: () => setSelectedInstanceId(instance.id), "data-testid": `project-instance-expand-${instance.id}`, children: [
            ...
            selectedInstance ? /* @__PURE__ */ jsxs("aside", { className: "project-inspector", "aria-label": "Selected project", "data-testid": "project-inspector", children: [
              /* @__PURE__ */ jsxs("header", { className: "project-inspector-header", children: [
                ...
                /* @__PURE__ */ jsx("button", { className: "danger-button", type: "button", disabled: mutationPending || !canWrite || !isOwner(selectedInstance.ownerId), title: !isOwner(selectedInstance.ownerId) ? "Only the project owner can delete or manage collaborators." : !canWrite ? "This host grants inspection only." : void 0, onClick: () => setInstanceDelete(selectedInstance), "data-testid": `project-instance-delete-${selectedInstance.id}`, children: "Delete" })
              ] }),
              /* @__PURE__ */ jsxs("section", { className: "people-strip", "aria-labelledby": `people-${selectedInstance.id}`, children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "people-list", children: [
                  selectedInstance.collaborators.map((person) => /* @__PURE__ */ jsxs("span", { className: "person-chip", "data-testid": `project-collaborator-${person.id}`, children: [
                    ...
                    /* @__PURE__ */ jsx("strong", { children: person.name }),
                    /* @__PURE__ */ jsx("button", { className: "icon-button", type: "button", disabled: !canWrite || !isOwner(selectedInstance.ownerId), "aria-label": `Remove ${person.name}`, onClick: () => void removeCollaborator(selectedInstance.id, person.id), "data-testid": `project-collaborator-remove-${person.id}`, children: "\xD7" })
                  ] }, person.id)),
                  /* @__PURE__ */ jsx("button", { className: "secondary-button", type: "button", disabled: !canWrite || !isOwner(selectedInstance.ownerId), onClick: () => setCollaboratorPickerFor(selectedInstance.id), "data-testid": "project-collaborator-add", children: "Add person" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "timeline-toolbar", children: [
                /* @__PURE__ */ jsx("h3", { children: "Milestones and steps" }),
                /* @__PURE__ */ jsx("button", { className: "secondary-button", type: "button", disabled: mutationPending || !canWrite || !isOwner(selectedInstance.ownerId), onClick: () => setMilestoneOpen(true), "data-testid": "project-milestone-add", children: "Add milestone" })
              ] }),
    ...
    /* @__PURE__ */ jsxs(FocusDialog, { open: Boolean(templateEditor), onClose: () => setTemplateEditor(null), title: templateEditor === "new" ? "New template" : "Edit template", description: "Templates stay reusable; project instances are unchanged.", testId: "project-template-dialog", children: [
      templateEditor && /* @__PURE__ */ jsxs("form", { className: "project-dialog-form", onSubmit: saveTemplate, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "dialog-actions", children: [
          ...
          /* @__PURE__ */ jsx("button", { className: "primary-button", type: "submit", disabled: !canWrite || mutationPending, "data-testid": "project-template-save", children: "Save template" })
        ] })
      ] }),
      templateEditor !== "new" && templateEditor && /* @__PURE__ */ jsxs("section", { className: "template-step-editor", "aria-labelledby": "project-template-steps-title", children: [
        /* @__PURE__ */ jsxs("header", { children: [
          ...
          /* @__PURE__ */ jsx("button", { className: "secondary-button", type: "button", disabled: !canWrite, title: !canWrite ? "This host grants inspection only." : void 0, onClick: () => setTemplateStepEditor({ templateId: templateEditor.id }), "data-testid": "project-template-step-add", children: "Add step" })
        ] }),
        templateEditor.steps.map((step) => /* @__PURE__ */ jsxs("div", { "data-testid": `project-template-step-${step.id}`, children: [
          ...
          /* @__PURE__ */ jsx("button", { className: "text-button", type: "button", disabled: !canWrite, onClick: () => setTemplateStepEditor({ templateId: templateEditor.id, step }), "data-testid": `project-template-step-edit-${step.id}`, children: "Edit" }),
          /* @__PURE__ */ jsx("button", { className: "text-danger-button", type: "button", disabled: !canWrite, onClick: () => void deleteTemplateStep(templateEditor.id, step.id), "data-testid": `project-template-step-delete-${step.id}`, children: "Delete" })
        ] }, step.id))
      ] })
    ] }),
    /* @__PURE__ */ jsx(FocusDialog, { open: Boolean(templateStepEditor), onClose: () => setTemplateStepEditor(null), title: templateStepEditor?.step ? "Edit template step" : "Add template step", description: "Offsets are relative to the project anchor date.", testId: "project-template-step-dialog", children: templateStepEditor && /* @__PURE__ */ jsxs("form", { className: "project-dialog-form", onSubmit: saveTemplateStep, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "dialog-actions", children: [
        ...
        /* @__PURE__ */ jsx("button", { className: "primary-button", type: "submit", disabled: !canWrite || mutationPending, "data-testid": "project-template-step-save", children: "Save step" })
      ] })
    ] }) }),
    ...
    /* @__PURE__ */ jsx(FocusDialog, { open: Boolean(collaboratorPickerFor), onClose: () => setCollaboratorPickerFor(null), title: "Add project collaborator", description: "The owner and existing collaborators are excluded.", testId: "project-collaborator-picker", children: /* @__PURE__ */ jsx("div", { className: "collaborator-options", role: "listbox", "aria-label": "Workspace members", children: collaboratorPickerFor && members.filter((person) => {
    ...
    }).map((person) => /* @__PURE__ */ jsxs("button", { className: "secondary-button", role: "option", "aria-selected": "false", type: "button", onClick: () => void addCollaborator(collaboratorPickerFor, person.id), "data-testid": `project-collaborator-option-${person.id}`, children: [
  ...
  return /* @__PURE__ */ jsx(ScreenRoot, { screenName: "Rhythms", testId: "rhythm-rhythms-screen", children: /* @__PURE__ */ jsxs("section", { className: "page-shell pg-rhythms", "aria-busy": surfaceState === "loading", children: [
    /* @__PURE__ */ jsxs("header", { className: "rhythms-header", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "rhythms-header-actions", children: [
        ...
        /* @__PURE__ */ jsx("button", { ref: newRuleTriggerRef, className: "primary-button", type: "button", disabled: !showsWorkspace || !canWrite, title: !canWrite ? "This host grants inspection only." : void 0, onClick: () => setCreateOpen(true), "data-testid": "rhythms-new-rule", children: "New rule" })
      ] })
    ] }),
        ...
        /* @__PURE__ */ jsx("aside", { className: "rhythms-detail-column", "aria-label": "Selected rhythm", children: selected ? /* @__PURE__ */ jsxs("section", { className: "rhythm-detail", "aria-labelledby": "rhythm-detail-title", "data-testid": "rhythm-detail", children: [
          ...
          /* @__PURE__ */ jsxs("section", { className: "rhythm-collaborators", "aria-labelledby": "rhythm-collaborators-title", children: [
            /* @__PURE__ */ jsxs("header", { children: [
              ...
              /* @__PURE__ */ jsx("button", { className: "secondary-button", type: "button", disabled: !canWrite || !isOwner(selected), onClick: () => setCollaboratorPickerOpen(true), "data-testid": "rhythm-add-collaborator", children: "Add collaborator" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "rhythm-people", children: selected.collaborators.length ? selected.collaborators.map((person) => /* @__PURE__ */ jsxs("div", { className: "rhythm-person", "data-testid": `rhythm-collaborator-${person.id}`, children: [
              /* @__PURE__ */ jsx("span", { "aria-hidden": "true", children: person.initials }),
              /* @__PURE__ */ jsx("strong", { children: person.name }),
              /* @__PURE__ */ jsx("button", { type: "button", disabled: !canWrite || !isOwner(selected), "aria-label": `Remove ${person.name}`, onClick: () => void removeCollaborator(person.id), "data-testid": `rhythm-remove-collaborator-${person.id}`, children: "Remove" })
          ...
          /* @__PURE__ */ jsxs("section", { className: "rhythm-detail-steps", "aria-labelledby": "rhythm-steps-title", children: [
            ...
            /* @__PURE__ */ jsxs("form", { className: "rhythm-add-step-form", onSubmit: addWorkflowStep, children: [
              /* @__PURE__ */ jsxs("label", { children: [
                "New step title",
                /* @__PURE__ */ jsx("input", { disabled: !canWrite || !isOwner(selected), value: stepTitle, onChange: (event) => setStepTitle(event.target.value), "data-testid": "rhythm-add-step-title" })
              ] }),
              /* @__PURE__ */ jsxs("label", { children: [
                "Assignee",
                /* @__PURE__ */ jsxs("select", { disabled: !canWrite || !isOwner(selected), value: stepAssignee, onChange: (event) => setStepAssignee(event.target.value), "data-testid": "rhythm-add-step-assignee", children: [
                  /* @__PURE__ */ jsx("option", { value: "", children: "None" }),
                  members.map((person) => /* @__PURE__ */ jsx("option", { value: person.id, children: person.name }, person.id))
                ] })
              ] }),
              /* @__PURE__ */ jsx("button", { className: "secondary-button", type: "submit", disabled: mutationPending || !canWrite || !isOwner(selected) || !stepTitle.trim(), "data-testid": "rhythm-add-step-submit", children: "Add step" })
            ] })
          ] })
    ...
    /* @__PURE__ */ jsx(FocusDialog, { open: createOpen, onClose: () => setCreateOpen(false), title: "New Recurring Rule", description: "Create a recurring rule with optional workflow steps.", testId: "rhythm-create-dialog", wide: true, children: /* @__PURE__ */ jsx(RuleForm, { idPrefix: "rhythm-create", initial: blankDraft(), members, onCancel: () => setCreateOpen(false), onSave: (draft) => void createRule(draft) }) }),
    /* @__PURE__ */ jsx(FocusDialog, { open: Boolean(deleteTarget), onClose: () => setDeleteTarget(null), title: deleteTarget ? `Delete "${deleteTarget.title}"?` : "Delete rhythm?", description: "This will not remove already-generated tasks.", testId: "rhythm-delete-dialog", children: /* @__PURE__ */ jsxs("div", { className: "dialog-actions", children: [
      /* @__PURE__ */ jsx("button", { className: "secondary-button", type: "button", onClick: () => setDeleteTarget(null), "data-testid": "rhythm-delete-cancel", children: "Cancel" }),
      /* @__PURE__ */ jsx("button", { className: "danger-button", type: "button", disabled: mutationPending, onClick: () => void confirmDelete(), "data-testid": "rhythm-delete-confirm", children: "Delete rule" })
    ] }) }),
    /* @__PURE__ */ jsx(FocusDialog, { open: collaboratorPickerOpen && Boolean(selected), onClose: () => setCollaboratorPickerOpen(false), title: "Add collaborator", description: "Owner and existing collaborators are excluded.", testId: "rhythm-collaborator-picker", children: /* @__PURE__ */ jsx("div", { className: "rhythm-candidate-list", role: "listbox", "aria-label": "Available workspace members", children: candidates.length ? candidates.map((person) => /* @__PURE__ */ jsxs("button", { className: "rhythm-candidate", role: "option", "aria-selected": "false", type: "button", onClick: () => void addCollaborator(person.id), "data-testid": `rhythm-collaborator-option-${person.id}`, children: [
      /* @__PURE__ */ jsx("span", { "aria-hidden": "true", children: person.initials }),
      /* @__PURE__ */ jsx("strong", { children: person.name })
    ] }, person.id)) : /* @__PURE__ */ jsx("p", { children: "No eligible workspace members." }) }) })
  ] }) });
}
...
function StatePanel9({ state, onRetry, onEmpty }) {
  ...
  if (state === "empty") {
    return /* @__PURE__ */ jsxs("section", { className: "tasks-state", role: "status", "data-testid": "page-state-empty", children: [
      ...
      /* @__PURE__ */ jsx("button", { className: "primary-button", type: "button", onClick: onEmpty, "data-testid": "tasks-empty-create", children: "Create a task" })
    ] });
  }
  if (state === "server_error") {
  ...
  return /* @__PURE__ */ jsx(ScreenRoot, { screenName: "Tasks", testId: "rhythm-tasks-screen", children: /* @__PURE__ */ jsxs("section", { className: "page-shell pg-tasks", "aria-busy": surfaceState === "loading", children: [
    /* @__PURE__ */ jsxs("header", { className: "tasks-header", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "tasks-header-actions", children: [
        ...
        /* @__PURE__ */ jsx(HeaderTaskAction, { onClick: () => setCreateOpen(true), disabled: !showsWorkspace || mutationPending, testId: "tasks-header-add-task" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "tasks-scroll", role: "region", "aria-label": "Tasks workspace content", tabIndex: 0, children: [
      !showsWorkspace && /* @__PURE__ */ jsx(StatePanel9, { state: surfaceState, onRetry: () => void load(), onEmpty: () => setCreateOpen(true) }),
      showsWorkspace && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "tasks-workspace-layout", children: [
          ...
          /* @__PURE__ */ jsx("aside", { className: "task-detail-column", "aria-label": "Selected task", "data-testid": "task-inspector", children: selectedTask ? /* @__PURE__ */ jsxs("section", { className: "task-detail", "aria-labelledby": "task-detail-title", children: [
            ...
            selectedReadonly && isSourceReadonly(selectedTask) && /* @__PURE__ */ jsxs("div", { className: "inspector-prerequisite", role: "status", children: [
              /* @__PURE__ */ jsx("strong", { children: "Synchronized source of truth" }),
              /* @__PURE__ */ jsx("span", { children: "This task is inspect-only here." })
            ] }),
            /* @__PURE__ */ jsxs("form", { className: "task-inspector-form", onSubmit: saveInspector, children: [
              ...
              /* @__PURE__ */ jsxs("fieldset", { disabled: selectedReadonly, children: [
                ...
                /* @__PURE__ */ jsxs("label", { children: [
                  "Title",
                  /* @__PURE__ */ jsx("input", { name: "title", required: true, defaultValue: selectedTask.title, "data-testid": "task-edit-title" })
                ] }),
                /* @__PURE__ */ jsxs("label", { children: [
                  "Notes",
                  /* @__PURE__ */ jsx("textarea", { name: "notes", rows: 4, defaultValue: selectedTask.notes, "data-testid": "task-edit-notes" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "inspector-pair", children: [
                  /* @__PURE__ */ jsxs("label", { children: [
                    "Scheduled date",
                    /* @__PURE__ */ jsx("input", { name: "scheduledDate", type: "date", defaultValue: selectedTask.scheduledDate ?? "", "data-testid": "task-edit-scheduled-date" })
                  ] }),
                  /* @__PURE__ */ jsxs("label", { children: [
                    "Due date",
                    /* @__PURE__ */ jsx("input", { name: "dueDate", type: "date", defaultValue: selectedTask.dueDate ?? "", "data-testid": "task-edit-due-date" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "inspector-pair", children: [
                  /* @__PURE__ */ jsxs("label", { children: [
                    "Default agent",
                    /* @__PURE__ */ jsxs("select", { name: "preferredAgent", defaultValue: selectedTask.preferredAgent, "data-testid": "task-edit-agent", children: [
                      /* @__PURE__ */ jsx("option", { value: "", children: "None" }),
                  ...
                  /* @__PURE__ */ jsxs("label", { children: [
                    "Energy",
                    /* @__PURE__ */ jsxs("select", { name: "energy", defaultValue: selectedTask.energy, "data-testid": "task-edit-energy", children: [
                      /* @__PURE__ */ jsx("option", { value: "", children: "None" }),
                ...
                /* @__PURE__ */ jsxs("footer", { className: "task-detail-form-actions", children: [
                  /* @__PURE__ */ jsx("button", { className: "secondary-button", type: "button", onClick: () => void changeStatus(selectedTask, selectedTask.status === "done" ? "open" : "done"), "data-testid": "task-detail-complete", children: selectedTask.status === "done" ? "Reopen" : "Complete" }),
                  /* @__PURE__ */ jsx("button", { className: "primary-button", type: "submit", "data-testid": "task-save", children: "Save changes" })
                ] })
              ] })
            ] }, selectedTask.id),
            ...
            !selectedReadonly && /* @__PURE__ */ jsxs("section", { className: "task-quick-actions", "aria-labelledby": "task-quick-title", children: [
    ...
    /* @__PURE__ */ jsxs(FocusDialog, { open: Boolean(deleteTarget), onClose: () => setDeleteTarget(null), title: deleteTarget ? `Delete "${deleteTarget.title}"?` : "Delete task?", description: "This cannot be undone.", testId: "task-delete-dialog", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "dialog-actions", children: [
        ...
        /* @__PURE__ */ jsx("button", { className: "danger-button", type: "button", disabled: mutationPending, onClick: () => void confirmDelete(), "data-testid": "task-delete-confirm", children: "Delete task" })
      ] })
    ] })
  ] }) });
}
